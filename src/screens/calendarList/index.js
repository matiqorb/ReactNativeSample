...
import {
  ...
  remove,
  loadEditItem
} from "../../redux/actions/calendarSetting";
...
class CalendarList extends Component {
  ...
  async componentDidMount() {
    InteractionManager.runAfterInteractions(() => {
      if (!this.props.calendars || this.props.calendars.length == 0) this.loadItems();
  ...
  onItemPresse = item => {
    if (this.state.selectMode) {
      ...
      setTimeout(() => {
        this.props.navigation.navigate("AddCalendar");
      }, 0);
    ...
    return (
      ...
      {this.state.selectMode ? (
        ...
        <FloatingAction
          ...
          position="right"
          onPressMain={() => this.onAddPress("AddCalendar")}
